...
contract AMMMathHarness {
    ...
    function invariant(uint256 reserveA, uint256 reserveB) external pure returns (uint256) {
        return AMMMath.invariant(reserveA, reserveB);
    }
}
...
contract AMMMathTest is Test {
    ...
    function testInvariantReturnsProduct() public view {
        assertEq(harness.invariant(12, 10), 120);
    }
}
