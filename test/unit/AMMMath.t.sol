...
contract AMMMathHarness {
    ...
    function calculateInvariant(
        ...
        returns (uint256)
    {
        return AMMMath.calculateInvariant(
            reserveA,
            reserveB
        );
    }
...
contract AMMMathTest is Test {
    ...
    function testGetAmountOutRevertsWhenReserveInIsZero() public {
        vm.expectRevert(
            AMMMath.InvalidReserves.selector
        );
    ...
    function testValidateSlippagePassesWhenOutputIsEnough()
        public
        view
    {
        harness.validateSlippage(
            100 ether,
            90 ether
        );
    }
    ...
    function testInvariantReturnsProduct() public view {
        assertEq(
            harness.calculateInvariant(12, 10),
            120
        );
    }
}