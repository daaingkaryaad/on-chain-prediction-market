...
export class ProtocolGovernor extends ethereum.SmartContract {
  ...
  PROPOSAL_THRESHOLD_PERCENTAGE(): BigInt {
    let result = super.call(
      "PROPOSAL_THRESHOLD_PERCENTAGE",
      "PROPOSAL_THRESHOLD_PERCENTAGE():(uint256)",
      [],
    );
  ...
  try_PROPOSAL_THRESHOLD_PERCENTAGE(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "PROPOSAL_THRESHOLD_PERCENTAGE",
      "PROPOSAL_THRESHOLD_PERCENTAGE():(uint256)",
      [],
  ...
  VOTING_DELAY_BLOCKS(): BigInt {
    let result = super.call(
      "VOTING_DELAY_BLOCKS",
      "VOTING_DELAY_BLOCKS():(uint48)",
      [],
    );
  ...
  try_VOTING_DELAY_BLOCKS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "VOTING_DELAY_BLOCKS",
      "VOTING_DELAY_BLOCKS():(uint48)",
      [],
  ...
  VOTING_PERIOD_BLOCKS(): BigInt {
    let result = super.call(
      "VOTING_PERIOD_BLOCKS",
      "VOTING_PERIOD_BLOCKS():(uint32)",
      [],
    );
  ...
  try_VOTING_PERIOD_BLOCKS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "VOTING_PERIOD_BLOCKS",
      "VOTING_PERIOD_BLOCKS():(uint32)",
      [],
